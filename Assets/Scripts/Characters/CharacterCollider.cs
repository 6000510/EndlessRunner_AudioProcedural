...
public class CharacterCollider : MonoBehaviour
{
    ...
    protected void OnTriggerEnter(Collider c)
    {
		...
		{
			if(Sintetizador.instancia != null) Sintetizador.instancia.Reproducir(1200f, Sintetizador.TipoOnda.Senoidal, 0.01f, 0.1f);
        ...
        {
			if(Sintetizador.instancia != null) Sintetizador.instancia.Reproducir(0f, Sintetizador.TipoOnda.Ruido, 0.01f, 0.5f);
        ...
        {
			if(Sintetizador.instancia != null) Sintetizador.instancia.Reproducir(800f, Sintetizador.TipoOnda.Senoidal, 0.1f, 0.4f);
