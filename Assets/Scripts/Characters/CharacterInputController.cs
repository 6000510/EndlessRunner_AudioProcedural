...
public class CharacterInputController : MonoBehaviour
{
    ...
    public void Jump()
    {
		if(Sintetizador.instancia != null) Sintetizador.instancia.Reproducir(800f, Sintetizador.TipoOnda.Senoidal, 0.02f, 0.3f);
	    if (!m_IsRunning)
		    return;
	...
	public void Slide()
	{
		if(Sintetizador.instancia != null) Sintetizador.instancia.Reproducir(0f, Sintetizador.TipoOnda.Ruido, 0.05f, 0.5f);
		if (!m_IsRunning)
			return;
    ...
    {
		if(Sintetizador.instancia != null) Sintetizador.instancia.Reproducir(300f, Sintetizador.TipoOnda.Senoidal, 0.02f, 0.15f);
		if (!m_IsRunning)
			return;
